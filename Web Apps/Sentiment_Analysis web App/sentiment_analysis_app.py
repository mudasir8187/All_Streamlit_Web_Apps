...
# Add Author Details
st.markdown("---")
st.markdown("### Author: Mudasir Ali")
...
st.markdown("""<div style="display: flex; align-items:center;">
  <a href="https://www.linkedin.com/in/mudasir-ali-0bb999246?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
  ...
  <a href="https://github.com/mudasir8187" target="_blank">
...
st.markdown("contact: chmudasir9990@gmail.com")
